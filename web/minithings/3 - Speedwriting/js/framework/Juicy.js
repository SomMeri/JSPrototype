...
Phaser.Plugin.Juicy.ScreenFlash = function(game, color) {
  ...
  this.game = game;
  this.sprite = new Phaser.Sprite(game, 0,0, bmd);
  this.sprite.z = -100;
  this.sprite.alpha = 0;
};
...
Phaser.Plugin.Juicy.ScreenFlash.prototype.flash = function(maxAlpha, duration) {
  ...
  var flashTween = this.game.add.tween(this.sprite).to({alpha: maxAlpha}, duration, Phaser.Easing.Bounce.InOut, true,0, 0, true);
