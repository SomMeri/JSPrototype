...
SoundGenerator.prototype.startExperiment = function () {
    this.table = [1760, [110, "200ms"]];
...
SoundGenerator.prototype.hitSimple = function () {
//    this.synth.noteOnWithFreq(this.midicps[this.chord[this.chordPosition]], 100);
